...
const WebVitalsPage: React.FC = () => {
  ...
  const handleDownloadHtml = async (run: RunInfo) => {
    try {
      const report = await getRunReport(run.run_id, 'html');
      ...
      <div className="page-content-wrapper">
        ...
        <div className="page-header">
          <div className="header-content">
            <h1>Web-Vitals & Lighthouse Analysis</h1>
          ...
          <div className="content-section">
            ...
            {filteredRuns.length === 0 ? (
              <div className="empty-state">
                ...
                <p>Upload Lighthouse JSON files to get started</p>
              </div>
            ) : (
