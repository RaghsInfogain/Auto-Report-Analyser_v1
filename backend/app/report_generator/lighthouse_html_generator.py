...
<body>
    ...
    def _generate_css() -> str:
        ...
        .card-value-large { font-size: 1.1rem; font-family: 'JetBrains Mono', monospace; }
        .status-good { background: var(--gn-lt); color: var(--gn); padding: 2px 7px; border-radius: 20px; font-size: 10px; font-weight: 500; }
        .status-warning { background: var(--am-lt); color: var(--am); padding: 2px 7px; border-radius: 20px; font-size: 10px; font-weight: 500; }
